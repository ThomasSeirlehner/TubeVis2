...
//
//  Datei:       d3dx12.h
//  Inhalt:    D3DX12-Dienstprogrammbibliothek
//
//////////////////////////////////////////////////////////////////////////////
...
struct CD3DX12_CLEAR_VALUE : public D3D12_CLEAR_VALUE
{
    ...
    {
        Format = format;
        /* memcpy zum Beibehalten von NAN-Werten verwenden*/
...
//------------------------------------------------------------------------------------------------
// Gibt die erforderliche Größe eines Puffers für den Datenupload zurück.
...
//------------------------------------------------------------------------------------------------
// Alle Arrays müssen ausgefüllt werden (z. B. durch Aufrufen von GetCopyableFootprints)
...
//------------------------------------------------------------------------------------------------
// Heapzuweisende UpdateSubresources-Implementierung
inline UINT64 UpdateSubresources( 
    _In_ ID3D12GraphicsCommandList* pCmdList,
    _In_ ID3D12Resource* pDestinationResource,
    _In_ ID3D12Resource* pIntermediate,
...
//------------------------------------------------------------------------------------------------
// Stapelzuweisende UpdateSubresources-Implementierung
...
{
    // Diese Umwandlung ist nützlich zum Übergeben von stark typisierten Befehlslistenzeigen in
    // ListeAusgeführterBefehle.
    // Diese Umwandlung ist gültig, wenn die Konstanteneigenschaft berücksichtigt wird. D3D12-APIs berücksichtigen diese.
    // berücksichtig die Konstanteneigenschaft der Argumente.
